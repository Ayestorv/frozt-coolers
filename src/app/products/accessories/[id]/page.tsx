...
export default function AccessoryProductPage() {
  ...
  const product = {
    ...
    price: 7.49,
    description: "Con la compra de cualquier modelo. Esta tapa magnética de alta calidad es perfectamente compatible con nuestros modelos de termos de 18oz, 32oz, 24oz y 40oz. El cierre magnético asegura que tu bebida se mantenga a la temperatura ideal y evita derrames.",
    compatibility: ["18oz", "32oz", "24oz", "40oz"],
    features: [
      "Cierre magnético",
      "Material de alta calidad",
      "Fácil de limpiar",
      "Diseño elegante",
      "100% compatible con modelos Frozt"
    ],
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 overflow-hidden shadow-xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="p-6 text-white">
                  ...
                  <div className="mb-6">
                    <h2 className="text-lg font-semibold mb-2">Compatible With</h2>
                    <div className="flex flex-wrap gap-2">
                      {product.compatibility.map((size) => (
                        <span 
                          key={size} 
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Link 
                      href={`https://wa.me/15551234567?text=I%27m%20interested%20in%20the%20${encodeURIComponent(product.model)}%20accessory`}
                      target="_blank"
